      ...
      <div class="ibox-body">
        <form class="form-horizontal" enctype="multipart/form-data" id="form-sample-1" method="post" novalidate="novalidate">
          ...
          <div class="form-group row" id="date_5">
            ...
            <div class="col-sm-5 input-group">
              <input class="input-sm form-control" type="text" id="actDateb"  data-toggle="datepicker"name="actDateb" autocomplete="off" required />
              <span class="input-group-addon p-l-10 p-r-10">ถึง</span>
              <input class="input-sm form-control" type="text" id="actDatee" data-toggle="datepicker"name="actDatee" autocomplete="off" required />
            </div>
          </div>
          <div class="form-group row">
