...
?>
    ...
    <tr>
        ...
        <td>
            <?php
            include '../control/parti_camp1_all.php';
            // output data of each row
            include '../control/parti_org_countactivity_year_all.php';
            ?>
        </td>
        <td>
            <?php
            include '../control/parti_camp1_run.php';
            // output data of each row
            include '../control/parti_org_countactivity_year_run.php';
            ?>
        </td>
        <td>
            <?php
            include '../control/parti_camp1_reg.php';
            include '../control/parti_org_countactivity_year_reg.php';
            ?>
        </td>
        <td>
    ...
    <tr>
        ...
        <td>
            <?php
            include '../control/parti_phathom_all.php';
            // output data of each row
            include '../control/parti_org_countactivity_year_all.php';
            ?>
        </td>
        <td>
            <?php
            include '../control/parti_phathom_run.php';
            // output data of each row
            include '../control/parti_org_countactivity_year_run.php';
            ?>
        </td>
        <td>
            <?php
            include '../control/parti_phathom_reg.php';
            // output data of each row
            include '../control/parti_org_countactivity_year_reg.php';
            ?>
        </td>
    ...
    <tr>
        <td style="color:#528124;">
            <h4>สรุปการเข้าร่วมกิจกรรมปี 1</h4>
        </td>
        <td></td>
        <td></td>
        <td></td>
        <td colspan="2" style="text-align:center;">
            <?php
            if (
                $halaqah1_1 == 'ผ่าน' && $halaqah1_2 == 'ผ่าน' && $qiyaam1_1 == 'ผ่าน' && $qiyaam1_2 == 'ผ่าน'
                && $eiatiqaf1 == 'ผ่าน' && $week1 == 'ผ่าน' && $phathom == 'ผ่าน' && $camp1 == 'ผ่าน'
                && $chomrom1 == 'ผ่าน' && $chumnum1 == 'ผ่าน' && $abc1 == 'ผ่าน' && $smo1 == 'ผ่าน'
            ) {
                $actyear1 = "ผ่าน";
            ?>
