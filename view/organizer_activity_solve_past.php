...
include '../control/organizer_activity_solve_past.php';
?>
  ...
  <div class="page-content fade-in-up" style="padding:20px;padding-top:0px">
    <div class="page-heading">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="organizer_activity_solve.php">กิจกรรมครั้งล่าสุด</a></li>
        <li class="breadcrumb-item">กิจกรรมที่ผ่านมา </li>
      </ol>
    </div>
    <br>
    <a href="organizer_activity_solve.php"><button class="btn btn-info" type="button"> &nbsp; กิจกรรมครั้งล่าสุด</button></a>
    <br>
    <br>
    <?php
    if (isset($errMSG)) {
      ...
      <div class="col-12">
        <div class="card" style="border-width:0px;border-bottom-width:4px;border-right-width:4px;">
          <div class="card-header" style="background-color:#d1cbaf">
            <h5 style="color:#2c2c2c">ตารางรายชื่อผู้จำนงแก้กิจกรรมที่ผ่านมา</h5>
          </div>
            ...
            <table id="tb1" class="table table-hover-sm table-striped " cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                $stmt = $session->runQuery("SELECT activity.*, acttype.*, actregister.*,actyear.*,student.*
                                              ...
                                              WHERE actyear.actyearStatus='สำเร็จกิจกรรม' && actregister.actregStatus ='จำนงแก้กิจกรรม' 
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <?php
                      if ($row['actregStatus'] == 'จำนงแก้กิจกรรม') {
                      ?>
                        <a class="btn btn-fix btn-sm btn-default" href="?actsolve_id=<?php echo $row['actregNo']; ?>"  onclick="return confirm('ยืนยันการแก้กิจกรรมนี้ ?')"> แก้กิจกรรมเรียบร้อย</a>
                      <?php
                      }
                      ?>
                    </td>
