                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            $stmt_act = $session->runQuery("SELECT * FROM activity 
                                                    ...
                                                    ");
                                            $stmt_act->execute();
                                            $row2 = $stmt_act->rowCount();
                                            $rowget2 = $stmt_act->fetch(PDO::FETCH_ASSOC);
                                            // output data of each row
                                            if ($row2 > 0) {
                                            ?>
                                                <a href="organizer_activity_year_run.php?actyear=<?php echo $year ?>"><?php echo $row2 ?></a>
                                            <?php
                                            } else if ($row2 < 0) {
                                            }
                                            ?>
