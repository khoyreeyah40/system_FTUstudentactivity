...
<head>
    <title>ระบบกิจกรรมนักศึกษา| กิจกรรมที่ได้ดำเนิน</title>
...
<body class="fixed-navbar">
    ...
    <div class="page-content fade-in-up" style="padding:20px;padding-top:0px">
        <div class="page-heading">
            <h1 class="page-title" style="color:#528124;">กิจกรรมที่ได้ดำเนิน</h1>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                </li>
                <li class="breadcrumb-item"><a href="organizer_activity_year_each.php">ตารางกิจกรรมแต่ละปี</a></li>
                <li class="breadcrumb-item">กิจกรรมที่ได้ดำเนิน</li>
            </ol>
        </div>
        <br>
                        ...
                        <table id="tb1" class="table table-striped table-hover" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                $stmt = $session->runQuery("SELECT activity.*, acttype.*
                                                                        ...
                                                                        WHERE 
                                                                            actYear = '$actyear' && actStatus != 'ลงในแผน'
