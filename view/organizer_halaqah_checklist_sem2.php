...
include '../control/organizer_halaqah_checklist_sem2.php';
?>
<!DOCTYPE html>
<html lang="en">

<head>
  <title>ระบบกิจกรรมนักศึกษา| จัดการกลุ่มศึกษาอัลกุรอ่าน: ตารางการเข้าร่วมภาคเรียนที่ 2</title>
...
<body class="fixed-navbar">
  <div class="page-content fade-in-up" style="padding:20px;padding-top:0px">
    <div class="page-heading">
      <h1 class="page-title">จัดการกลุ่มศึกษาอัลกุรอ่าน: การเข้าร่วมภาคเรียนที่ 2</h1>
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
        </li>
        <li class="breadcrumb-item"><a href="organizer_halaqah.php">จัดการกลุ่มศึกษาอัลกุรอ่าน</a></li>
        <li class="breadcrumb-item">การเข้าร่วมภาคเรียนที่ 2</li>
      </ol>
    </div>
    <br>
            ...
            <table id="tb1" class="table table-hover-sm table-striped" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                $stmt = $session->runQuery("SELECT * FROM halaqahchecklist
                                            WHERE halaqahID = '$halaqah_id' && actSem ='2'
