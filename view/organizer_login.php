...
<head>
    ...
    <title>ระบบกิจกรรมนักศึกษา| Login สำหรับเจ้าหน้าที่</title>
    <style>
        .breadcrumb-item {
            font-size: 16px;
        }
                    ...
                    <div class="col-6 ">
                        <div class="card" style="border-width:0px;border-top-width:4px;margin: 20px;">
                            <div class="row justify-content-center">
                                <div class="col-sm-10 ">
                                    <form id="login-form" action="../control/organizer_login.php" method="post">
                                        <h2 class="login-title">Log in</h2>
                                        <h5 class="login-title">(สำหรับเจ้าหน้าที่)</h5>
                                        <div class="form-group">
                                            <div class="input-group-icon right">
                                                <div class="input-icon">
                                                    <i class="fa fa-id-card"></i>
                                                </div>
                                                <input class="form-control" type="text" name="orgzerID" placeholder="ORG00000" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="input-group-icon right">
                                                ...
                                                <input class="form-control" type="password" name="orgzerPassword" placeholder="Password">
                                            </div>
                                        </div>
                                        <div class="form-group">
