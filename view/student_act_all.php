...
include '../control/student_activity_all_past_search.php';
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="fixed-navbar">
  ...
  <div class="page-content fade-in-up" style="padding:20px;padding-top:0px">
    <div class="page-heading">
      <h1 class="page-title" style="color:#528124;">ตารางกิจกรรมทั้งหมดในปีนี้</h1>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"></li>
        <li class="breadcrumb-item"><a href="student_home.php">หน้าแรก</a></li>
        <li class="breadcrumb-item">ตารางกิจกรรมทั้งหมดในปีนี้</li>
      </ol>
    </div>
    <br>
