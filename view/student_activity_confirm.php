                                            ...
                                            <?php } else { ?>
                                                <form class="form-horizontal" id="form-sample-1" method="post" novalidate="novalidate">
                                                    <div class="form-group row">
                                                        <div class="col-sm-5 text-center wrap">
                                                            <input class="form-control" type="text" name="confirm_id" required />
                                                            <input class="form-control" type="hidden" name="halaqahcheckstd_id" value="<?php echo $row['halaqahstdNo']; ?>" required />
                                                            <input class="form-control" type="hidden" name="halaqahchecklist_no" value="<?php echo $row['halaqahchecklistNo']; ?>" required />
                                                        </div>
                                                        <div class="col-sm-3 text-center">
                                                            <button class="btn btn-sm  btn-success" type="submit" name="btconfirmhalaqah" title="ยืนยันเข้าร่วมกิจกรรม" onclick="return confirm('ต้องการยืนยันการเข้าร่วมกิจกรรม ?')"> ยืนยัน</a>
                                                        </div>
                                                    </div>
                                                </form>
                                            <?php } ?>
                ...
                <div class="card" style="border-width:0px;border-top-width:4px;">
                    <div class="card-body text-nowrap">
                        <table id="tb2" class="table table-hover table-striped" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php
                                $stmt = $session->runQuery("SELECT activity.* ,actregister.*, acttype.*  FROM actregister
                                            ...
                                            ?>
                                                <form class="form-horizontal" id="form-sample-1" method="post" novalidate="novalidate">
                                                    <div class="form-group row">
                                                        <div class="col-sm-5 text-center wrap">
                                                            <input class="form-control" type="text" name="confirm_id" required />
                                                            <input class="form-control" type="hidden" name="check_id" value="<?php echo $row['actregNo']; ?>" required />
                                                            <input class="form-control" type="hidden" name="act_id" value="<?php echo $row['actID']; ?>" required />
                                                        </div>
                                                        <div class="col-sm-3 text-center">
                                                            <button class="btn btn-sm  btn-success" type="submit" name="btconfirm" title="ยืนยันเข้าร่วมกิจกรรม" onclick="return confirm('ต้องการยืนยันการเข้าร่วมกิจกรรม ?')"> ยืนยัน</a>
                                                        </div>
                                                    </div>
                                                </form>
                                            <?php
                                            ...
                                            ?>
                                                <form class="form-horizontal" id="form-sample-1" method="post" novalidate="novalidate">
                                                    <div class="form-group row">
                                                        <div class="col-sm-5 text-center wrap">
                                                            <input class="form-control" type="text" name="confirm_id" required />
                                                            <input class="form-control" type="hidden" name="checksolve_id" value="<?php echo $row['actregNo']; ?>" required />
                                                            <input class="form-control" type="hidden" name="act_id" value="<?php echo $row['actID']; ?>" required />
                                                            <input class="form-control" type="hidden" name="actsem" value="<?php echo $row['actSem']; ?>" required />
                                                            <input class="form-control" type="hidden" name="actmainorg" value="<?php echo $row['actMainorg']; ?>" required />
                                                            <input class="form-control" type="hidden" name="actorgtion" value="<?php echo $row['actOrgtion']; ?>" required />
                                                            <input class="form-control" type="hidden" name="actsec" value="<?php echo $row['actSec']; ?>" required />
                                                            <input class="form-control" type="hidden" name="stdid" value="<?php echo $row['actregstdID']; ?>" required />
                                                        </div>
                                                        <div class="col-sm-3 text-center">
                                                            <button class="btn btn-sm  btn-success" type="submit" name="btconfirmsolve" title="ยืนยันเข้าร่วมกิจกรรม" onclick="return confirm('ต้องการยืนยันการเข้าร่วมกิจกรรม ?')"> ยืนยัน</a>
                                                        </div>
                                                    </div>
                                                </form>
                                            <?php
