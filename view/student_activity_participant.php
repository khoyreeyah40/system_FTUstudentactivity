...
include '../control/student_activity_participant.php';
?>
                    ...
                    <div class="card-body ">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="pill-1-1">
                                ...
                                <?php include 'student_activity_participant_result.php' ?>
                                <br>
                                <div class="row justify-content-center">
                                                        ...
                                                        <table id="tbact1" class="table table-condensed ">
                                                            <thead>
                                                                <tr style="color:#528124;">
                                                                    ...
                                                                    <th>จำนวนครั้งที่จัดไปแล้ว</th>
                                                                    <th>จำนวนครั้งที่เข้าร่วม</th>
                                                                    <th>ผลการประเมิน</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <?php include 'student_activity_participant_act_y1.php'; ?>
                                                            </tbody>
                                                        </table>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col-md-12">
                                                        <table id="tbact1" class="table table-condensed ">
                                                            ...
                                                            <tbody>
                                                                <?php include 'student_activity_participant_act_y2.php'; ?>
                                                            </tbody>
                                                        </table>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col-md-12">
                                                        <table id="tbact1" class="table table-condensed ">
                                                            ...
                                                            <tbody>
                                                                <?php include 'student_activity_participant_act_y3.php'; ?>
                                                            </tbody>
                                                        </table>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col-md-12">
                                                        <table id="tbact1" class="table table-condensed ">
                                                            ...
                                                            <tbody>
                                                                <?php include 'student_activity_participant_act_y4.php'; ?>
                                                            </tbody>
                                                        </table>
                                                    </div>
                                                </div>
