...
?>
    ...
    <tr>
        ...
        <td>
            <?php
            include '../control/parti_camp3_all.php';
            // output data of each row
            include '../control/parti_std_countactivity_year_all.php';
            ?>
        </td>
        <td>
            <?php
            include '../control/parti_camp3_run.php';
            // output data of each row
            include '../control/parti_std_countactivity_year_run.php';
            ?>
        </td>
        <td>
            <?php
            include '../control/parti_camp3_reg.php';
            include '../control/parti_std_countactivity_year_reg.php';
            ?>
        </td>
        <td>
    ...
    <tr>
        <td style="color:#528124;">
            <h4>สรุปการเข้าร่วมกิจกรรมปี 3</h4>
        </td>
        <td></td>
        <td></td>
        <td></td>
        <td colspan="2" style="text-align:center;">
            <?php
            if (
                $halaqah3_1 == 'ผ่าน' && $halaqah3_2 == 'ผ่าน' && $qiyaam3_1 == 'ผ่าน' && $qiyaam3_2 == 'ผ่าน' && $eiatiqaf3 == 'ผ่าน'
                && $week3 == 'ผ่าน' && $camp3 == 'ผ่าน' && $chomrom3 == 'ผ่าน' && $chumnum3 == 'ผ่าน'
                && $abc3 == 'ผ่าน' && $smo3 == 'ผ่าน'
            ) {
                $actyear3 = "ผ่าน";
            ?>
